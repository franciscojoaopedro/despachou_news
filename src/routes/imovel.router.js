...
const { validacaoPublicarImovel } = require("../middleware/middleware.imovell")
...
router_imovel.post("/publicar",upload.array("image",5),validacaoPublicarImovel,publicar_um_imovel)
